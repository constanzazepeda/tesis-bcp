...
foreach r of local metric {
	...
	graph_export(${resultados}/freq mensual/$reps reps cov/`r'/sdid_`r'_`m'_, .png);
	#delimit cr
...
foreach r of local metric {
	...
	sdid `r'_`m' g monthly_date trat, vce(placebo) reps($reps) seed($seed)  covariates(cuarentena , optimized)
		graph g2_opt( xtitle("") scheme(plotplainblind))
	graph_export(${resultados}/freq mensual/$reps reps cov comer/`r'/sdid_`r'_`m'_, .png);
	#delimit cr
...
foreach r of local metric {
	...
	sdid `r'_`m' g w trat_pos_pandemic, vce(placebo) reps($reps) seed($seed) covariates(cuarentena , optimized)
		graph g2_opt( xtitle("") scheme(plotplainblind))
	graph_export(${resultados}/freq mensual/$reps reps antes dps cov/`r'/sdid_`r'_`m'_, .png);
	#delimit cr
...
foreach r of local metric {
	...
	sdid `r'_`m' g monthly_date trat, vce(placebo) reps($reps) seed($seed)  covariates(cuarentena , optimized)
		graph g2_opt( xtitle("") scheme(plotplainblind))
	graph_export(${resultados}/freq mensual/$reps reps cov exito coord/`r'/sdid_`r'_`m'_, .png);
	#delimit cr
...
foreach r of local metric {
	...
	sdid `r'_`m' g monthly_date trat, vce(placebo) reps($reps) seed($seed)  covariates(cuarentena , optimized)
		graph g2_opt( xtitle("") scheme(plotplainblind))
	graph_export(${resultados}/freq mensual/$reps reps cov exito programa/`r'/`r'/sdid_`r'_`m'_, .png);
	#delimit cr
...
foreach r of local metric {
	...
	sdid `r'_`m' g weekly_date trat, vce(placebo) reps($reps) seed($seed)  covariates(cuarentena , optimized)
		graph g2_opt( xtitle("") scheme(plotplainblind))
	graph_export(${resultados}/freq semanal/$reps reps cov/`r'/sdid_`r'_`m'_, .png);
	#delimit cr
